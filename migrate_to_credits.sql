...
ALTER TABLE public.profiles
ADD COLUMN IF NOT EXISTS credit_balance INTEGER DEFAULT 100, -- Start with 100 free credits
ADD COLUMN IF NOT EXISTS monthly_credit_allowance INTEGER DEFAULT 100, -- Free plan gets 100/month
