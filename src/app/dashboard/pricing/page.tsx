      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-gray-600">
            Current balance: <span className="font-semibold text-black">{creditBalance} credits</span>
          </p>
        </div>

        {/* Subscription Plans */}
        <div className="mb-16">
          <h2 className="mb-6 text-2xl font-semibold text-gray-900">Monthly Subscriptions</h2>
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-2xl border-2 border-gray-200 bg-white p-8">
              ...
              <ul className="mb-8 space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-sm text-gray-600">100 credits per day</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="h-5 w-5 shrink-0 text-green-500" />
            ...
            {/* Pro Plan */}
            <div className="relative rounded-2xl border-2 border-black bg-white p-8 shadow-lg">
              ...
              <ul className="mb-8 space-y-3">
                <li className="flex items-start gap-2">
                  <Check className="h-5 w-5 shrink-0 text-green-500" />
                  <span className="text-sm text-gray-600">2,500 credits per month</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="h-5 w-5 shrink-0 text-green-500" />
            ...
            <div className="rounded-2xl border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-white p-8">
              ...
              <ul className="mb-8 space-y-3">
                <li className="flex items-start gap-2">
                  <Check className="h-5 w-5 shrink-0 text-green-500" />
                  <span className="text-sm text-gray-600">6,000 credits per month</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="h-5 w-5 shrink-0 text-green-500" />
                  <span className="text-sm text-gray-600">Priority support</span>
        ...
        {/* Credit Packs */}
        <div>
          <h2 className="mb-6 text-2xl font-semibold text-gray-900">One-Time Credit Packs</h2>
          <div className="grid gap-6 md:grid-cols-3">
            {/* Small Pack */}
        ...
        <div className="mt-12 rounded-xl bg-white p-8 shadow-sm">
          <h3 className="mb-4 text-xl font-semibold">How Credits Work</h3>
