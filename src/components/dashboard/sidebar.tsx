...
export function Sidebar({
  ...
  if (!profile.is_master) {
    navItems.push({ href: '/dashboard/billing', icon: CreditCard, label: 'Billing' })
  }
    ...
    <aside className="flex h-full w-full flex-col border-r border-gray-200 bg-white">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            {filteredConversations.length === 0 ? (
              ...
              <div
                className="space-y-1 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent hover:scrollbar-thumb-gray-400"
                        ...
                        <div className="relative">
                          ...
                          {menuOpen && (
                            <div
                              ...
                              className="absolute right-0 top-full mt-1 w-48 rounded-lg border border-gray-200 bg-white shadow-lg z-10"
                            >
                              <div className="py-1">
                                <button
        ...
        <div className="border-t border-gray-200 pt-4">
          <CreditDisplay userId={profile.id} className="mb-4" />
        </div>

        {/* Billing Link for non-master users */}
        {!profile.is_master && (
          <div>
            <Link
